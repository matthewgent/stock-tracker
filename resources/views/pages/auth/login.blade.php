...
<div id="login" class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-12">
            <div id="create-account" class="row justify-content-center align-items-center mt-5">
                <div class="col-12 col-md-6 text-center text-md-end mb-2 mb-md-0">
                    <div>Don't have an account?</div>
                </div>
                <div class="col-12 col-md-6 text-center text-md-start">
                    <a href="{{ route('register') }}" class="d-inline-block button-gold">Create an Account</a>
                </div>
            </div>
        </div>
    </div>
